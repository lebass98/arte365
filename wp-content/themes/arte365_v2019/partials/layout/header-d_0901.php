...
<div class="event_wrap" style="display:block;">
 	<div class="event_banner">
 		<a href="/?p=105128" target="_blank"><img src="/wp-content/uploads/2024/08/event_20240819_main.jpg" alt="" ></a>
		<button type="button" class="event_close"></button>
 	</div> 
</div>
<!-- <div class="event_wrap" style="display:block;">
 	<div class="event_banner">
 		<a href="/?p=104517" target="_blank"><img src="/wp-content/uploads/2024/07/event_20240701_main.jpg" alt="" ></a>
		<button type="button" class="event_close"></button>
 	</div> 
</div> -->
<!--<div class="event_wrap" style="display:block;">
				...
				<div class="inner">
					<ul>
						...
						<li>
							...
							<p><a href="/?post_type=subject&as_post=<?php echo $year_subject_id; ?>" target="_self">주제별 전체기사</a></p>
			...
			<div class="search-form">
				...
				<form id="search_Form" method="get">
					<select name="term_id" title="카테고리 선택 클릭">
						...
						<option value="6188" <?php echo (isset($_GET['term_id']) && $_GET['term_id'] == 6188) ? 'selected="selected"': '';?>>사람</option>
						<option value="6189" <?php echo (isset($_GET['term_id']) && $_GET['term_id'] == 6189) ? 'selected="selected"': '';?>>현장</option>
