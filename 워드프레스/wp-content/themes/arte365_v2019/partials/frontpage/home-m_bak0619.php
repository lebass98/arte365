...
<style>
/* -----------------------------메인 이미지----------------------- */
/* #main .home-main-banner{height:397px;background: url(/wp-content/uploads/2020/01/bee_200113_main_m.png) no-repeat;background-position: 0 18px;background-size: 100%;} */
#main .home-main-banner{height:590px;background: url(/wp-content/uploads/2023/06/bee_20230612_main_m.jpg) no-repeat;background-position: right 101px;background-size:cover;}
#main .home-main-banner .banner-desc .post-meta{top:80px;left:25px;}
.post-item:first-child .tb{background:url(/wp-content/uploads/2023/06/um_20230612_main.jpg) no-repeat center center;background-size:contain;background-position:0 0}
/* .post-item:nth-child(2) .tb{background:url(/wp-content/uploads/2021/10/ssak_20211025_main_m_.jpg) no-repeat 0 0;background-size:contain;background-position:0 0} */
/* .post-item:nth-child(2) .authur, .post-item:nth-child(3) .authur{display:none} */
.post-item:last-child .tb{background:url(/wp-content/uploads/2023/06/ssak_20230612_main.jpg) no-repeat 0 0;background-size:contain;background-position:0 0}
/* -----------------------------메인 이미지----------------------- */


	.featured-posts .post-item:first-child .tb:before{background-size:100% 90%;opacity:1}
	.featured-posts .post-item:last-child .tb:before{background-size:100% 77%;}
	...
	#main	.home-main-banner .banner-desc .post-meta{top: 12%; bottom: 5%; left: 85px;width: 74%;  text-align:left}
	
	.cover-bg:before{display:block;width:100%;height:100%;content:""} 

	@media (min-width:600px){
		#main .home-main-banner .banner-desc .post-meta{top:80px;left:45px;}
	}

 	 @media screen and (max-width:1024px){
 			.home-main-banner .banner-desc .post-meta .post-excerpt{width:85%;}
 		}
	...
	a[href="http://arte365.kr/?p=78449"] .authur{color:#000;}
	a[href="http://arte365.kr/?p=78449"] .tb:before{display:none}
	a[href="http://arte365.kr/?p=74753"] .post-meta{display:none}
...
<div class="featured-posts">
    ...
    <div class="main_subject_wrap">
		<div class="curationWrap">
			...
			<div class="row curation">
				<div class="col-sm-12 col-md-5" style="padding:0;">
					<div class="subject_list">
						<div class="subject_tab_title"><span>주제별</span> 큐레이션</div>
							...
							if ( $subjects->have_posts() ) :
								while ( $subjects->have_posts() ) :
									...
									<div class="swiper-slide">
										<a class="slide_txt move3" id="<?php the_ID(); ?>-tab" data-toggle="tab" href="/?p=<?php the_ID(); ?>" role="tab" aria-controls="<?php the_ID(); ?>" aria-selected="true">
											<p><?php the_title();?></p>
										</a>
									</div>
								<?php
						...
						<div class="main-tab-content" id="myTabContent">
							...
							if ( $subjects->have_posts() ) :
								while ( $subjects->have_posts() ) :
									...
									?>
									<div class="tab_box multiple-swiper-container swiper-container">
										<?php
										if ( $sub_posts->have_posts() ) :
											...
											while ( $sub_posts->have_posts() ) :
												...
												<div class="swiper-slide" style="width: 50%">
													<a class="main_tab_box" href="/?p=<?php the_ID(); ?>" target="_self" title="<?php the_title();?> 기사보기 클릭">
														<!--<div class="subject_tit">
														<?php
														//2021/05/24__서브 타이틀 구분
														if($subjects_id=='81205'){ echo "인간의 감성을 돕는 기술";}
														else if($subjects_id=='81204'){echo "전화의 시대를 건너는 예술교육";}
														else if($subjects_id=='85855'){echo "생애전환 문화 예술 교육";}
														else if($subjects_id=='81806'){echo "생활중심 문화예술교육";}
														else if($subjects_id=='84282'){echo "2020년 결산과 2021년 전망";}
														else if($subjects_id=='84277'){echo "사회적회복력으로서 문화예술";}
														else if($subjects_id=='83531'){echo "코로나19, 문화예술의 성찰";}
														else if($subjects_id=='83065'){echo "도시의 삶과 문화예술교육";}
														else if($subjects_id=='82420'){echo "지탱가능성";}
														else if($subjects_id=='81445'){echo "작지만 큰 공존을 위하여";}
														else if($subjects_id=='80686'){echo "학교문화예술교육";}
														else if($subjects_id=='80686'){echo "도시의 삶과 문화예술교육";}
														else if($subjects_id=='80682'){echo "지구를 생각하는 예술";}
														?>

													</div>-->
														<div class="category"><?php the_arte365_get_category_string();?></div>
														<div class="slide_tit"><?php the_title();?></div>
														<div class="slide_subtit ellipsis"><?php the_field('small_title');?></div>
														<span class="authur"><?php the_field('publisher');?></span>
													</a>
												</div>
												<?php
			...
			<button type="button" style="display: block;margin: 40px 3% 0 3%;padding:0 5px 0 5px;bottom:0;width:94%;height:48px;color:#fff;border: 1px solid #c8c8c8;background-color:#333333;line-height:48px;font-size:18px;text-align:center;cursor:pointer;z-index: 10; box-sizing: border-box;font-weight:300;" onclick="location.href='/?post_type=subject&as_post=<?php echo $year_subject_id; ?>';"  title="주제별 전체기사 보기 클릭">주제별 전체기사</button>
                ...
                <div class="left-area">
                    <div class="tab-content active" id="recentPosts">
							...
							<div class="text-center mt_30">
								<!-- <button type="button" id="main_post_add">더보기</button> -->
                ...
                <div class="tab-content clearfix">
                    <div class="mainVideo">
                        <div class="post-item movie-item clearfix wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                            <article class="post videoBig" id="post-<?php the_ID(); ?>">
                                <!-- 동영상 -->
                                <div>
                    ...
                    <div id="ajax-posts" class="post-list is-parent-category vScroll">
                        <div class="swiper mySwiper">
                            ...
                            <!-- <div class="text-center mt_10">
                                <button type="button" class="btn_more_post" id="more_posts">
                                    <img src="http://arte365.kr/wp-content/uploads/2019/07/btn_more.png" alt="">
                                </button>
                            </div> -->
