    ...
    <div class="container">
        ...
        <div class="inner">
            ...
            <div class="company-info">
                ...
                <p class="company-info--tit">아르떼 <span>365</span></p>
                <p>(03926) 서울특별시 마포구 상암산로 76(상암동, YTN 뉴스퀘어) 11~12층</p>
                <p>Tel 02-6209-5947</p>
                <p> 발행인 : 임진택  담당부서 : 정책확산팀</p>
            </div>
            ...
            <div class="copy">
                &copy; 2025 KOREA ARTS &amp; CULTURE EDUCATION SERVICE.
            </div>
            <!-- <div class="copy">
                Copyright <?php echo date('Y');?> KOREA ARTS &amp; CULTURE EDUCATION SERVICE. All Rights reserved.
            </div> -->
        </div>
    </div>
</footer><!--// footer -->